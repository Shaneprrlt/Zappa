...
class Zappa:
    ...
    def create_handler_venv(self):
        ...
        custom_zappa_source = 'git+https://github.com/Shaneprrlt/Zappa'
        if custom_zappa_source:
            # add dependencies, but not zappa
            pkg_list = []
            ...
            pkg_list.append(f'{custom_zappa_source}@{zappa_version}')
        else:
